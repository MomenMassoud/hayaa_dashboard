...
import 'package:dashboard/featurs/dashboard/views/edit_store_view.dart';
import 'package:dashboard/featurs/dashboard/views/history_item_view.dart';
import 'package:flutter/material.dart';

class CarBody extends StatefulWidget{
  _CarBody createState()=>_CarBody();
}


class _CarBody extends State<CarBody>{
  final FirebaseFirestore _firestore=FirebaseFirestore.instance;
  @override
  Widget build(BuildContext context) {
    final double screenWidth = MediaQuery.of(context).size.width;
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore.collection('store').where('cat',isEqualTo: 'car').snapshots(),
      builder: (context,snapshot){
        ...
        return Scaffold(
          body: Padding(
            ...
            child: Column(
              children: [
                Text(" Numbers of Car : ${store.length.toString()}"),
                const SizedBox(
                  height: 30,
                ),
                Row(
